...
matplotlib.use("Pdf")
import cv2
caffe_root = '/home/zym/caffe-master/build/install/python/'  #change to your caffe root path
import sys
...
class FaceDetector_mt(object):
    ...
    def __init__(self,
        ...
        model_P = '/root/PycharmProjects/cmodel_register/mtcnn/model/det1.prototxt'
        weights_P = '/root/PycharmProjects/cmodel_register/mtcnn/model/det1.caffemodel'
        model_R = '/root/PycharmProjects/cmodel_register/mtcnn/model/det2.prototxt'
        weights_R = '/root/PycharmProjects/cmodel_register/mtcnn/model/det2.caffemodel'
        model_O = '/root/PycharmProjects/cmodel_register/mtcnn/model/det3.prototxt'
        weights_O = '/root/PycharmProjects/cmodel_register/mtcnn/model/det3.caffemodel'
       # weights_cl = '/home/david/models_and_deploy/cl-net/CLNET.caffemodel'
       # model_cl = '/home/david/models_and_deploy/cl-net/CL_deploy.prototxt'
       # model_lt = '/home/david/models_and_deploy/light-cnn/LT_deploy.prototxt'
       # weights_lt = '/home/david/models_and_deploy/light-cnn/LT-net.caffemodel'
    ...
    def recognise_cm(self,im_name):
        feature = np.random.random((1, 512)).astype('float32')
        feature = cmodel.feature_main(im_name, feature)
